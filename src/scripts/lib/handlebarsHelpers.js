import { itemWithNoSlots, leftItem, rightItem } from "../constants/objectClassNames.js";
...
const registerHelpers = () => {
    ...
    Handlebars.registerHelper(
        "itemHasEnoughFreeSlots",
        function (slotStructure, requiredSlots, flagsForSlot, index, id) {
